...
print(f"The total of all the loans are {total_all_loans}.")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan = (total_all_loans/number_of_loans)
...
present_value = calculate_present_value(annual_discount_rate=0.2, future_value=1000, remaining_months=12)
